...
<div class="panel col-lg-12">
	<h3>
		<i class="icon-folder"></i> {l s='backups list files' mod='rjbackup'}
	...
	<div id="backupsContentFiles" class="table-responsive-row clearfix">
		<table id="backupFiles" class="table backupFiles">
			<thead>
					...
					<td>
						<div class="btn-group-action pull-right">
							...
							<a class="btn btn-default"
								...
								href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=rjbackup&type_file=F&delete_id_backup={$backup.file|escape:'htmlall':'UTF-8'}">
								<i class="icon-trash"></i>
							</a>
							<a class="btn btn-default"
								title= "{l s='send for FTP' mod='rjbackup'}"
								href="{$link->getAdminLink('AdminModules')|escape:'htmlall':'UTF-8'}&configure=rjbackup&type_file=F&send_ftp={$backup.file|escape:'htmlall':'UTF-8'}">
								<i class="icon-send"></i>
							</a>
						</div>
					</td>
